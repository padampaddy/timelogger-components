...
export default function LeaveCards({ variant, children }) {
  const beforeStyles = {
    width: 35,
    height: 35,
    display: 'inline-flex',
...
LeaveCards.propTypes = {
  variant: PropTypes.oneOf(['AvailableLeave', 'danger', 'CarryForwardLeave', 'UnpaidLeave']).isRequired,
